...
class CategoryController extends Controller
{
    ...
    public function store(Request $request, Category $category)
    {
        ...
        return redirect()->route('categories.index')->with('message', 'Category Successfully');
    }
    ...
    public function show_all(Category $category)
    {
        $categories = Category::orderBy('id' ,'desc')->paginate(10);

        return view('categories.view_all', compact('categories'));
    }
